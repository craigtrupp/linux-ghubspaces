#/bin/bash
# Remember default delimiter is a tab (no arg needed)
# To maintain delimited spaces need to echo the line argument as below 
...
## My passing output (Same input as sample)
# 1	New York, New York[10]	8,244,910
# 2	Los Angeles, California	3,819,702
# 3	Chicago, Illinois	2,707,120
# 4	Houston, Texas	2,145,146
